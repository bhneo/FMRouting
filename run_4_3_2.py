...
def run(args):
    os.system(
        'python ./main_multi.py --idx={} --model={} --atoms={} --recons_conv=True --recons_share=True --batch={} --gpu={} --steps=40000'.format(
            str(args.idx), args.model, str(args.atoms), args.batch_size, str(args.gpu)))
